...
# Load data 
setwd("C://Users//Dennis//Documents//Study//Thesis//DFROG//Dennis - Copy (2)//Factor extraction new methods//Extend PCA 2 lags")
...
for (version in c(1,2)) {
  setwd("C://Users//Dennis//Documents//Study//Thesis//DFROG//Dennis - Copy (2)//Factor extraction new methods//Extend PCA 2 lags")
  if (version == 1) {
    modelName  <- "Extended 2 lags  MIDAS-F U 1991M8 LagOrder 2"
    LagOrder   <- 2
    typeFlag   <- 0 
  } else if (version == 2) {
    modelName  <- "Extended 2 lags  MIDAS-F R 1991M8 LagOrder 2"
    LagOrder   <- 2
    typeFlag   <- 1
}
  ...
  if (saveFlag == 1) {
    ...
    setwd("C://Users//Dennis//Documents//Study//Thesis//Forecast results//Factor extraction methods//Extend 2 lags")
