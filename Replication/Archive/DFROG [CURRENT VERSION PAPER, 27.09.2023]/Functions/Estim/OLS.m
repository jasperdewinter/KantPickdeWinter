function [b, Sig] = OLS(Y,Z,cflag,sflag)
%______________________________________________________________________________
% [b, Sig] = OLS(Y,Z,cflag,sflag)
...
%  Sig        Covmat of residuals - Choleski decomp!       (1 x k)
%  sig_b      Standard error of estimates                  (1 x k)
%  t_val      t-values                                     (1 x k)
%______________________________________________________________________________
