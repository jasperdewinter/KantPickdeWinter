...
for (b in 1:length(index)) {
  ...
  avg_contributions[b,] <- colMeans( matrix(perc_contr[ !is.na(perc_contr) ],nrow = row, ncol=252) )
}

# plot(avg_contributions[1,-1])
