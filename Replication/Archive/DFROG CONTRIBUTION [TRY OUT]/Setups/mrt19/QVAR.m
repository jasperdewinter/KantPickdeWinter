...
%%                   UNWEIGHTED AVERAGE VAR ESTIMATION
%
%                         Jasper de Winter
...
%                         February 7 2012
%
%  The program evaluates the forecast performance of a quarterly VAR
%           to forecast quarterly GDP from monthly series
%      The program runs recursive forecasts and calculates the RMSEs
%  Estimates a bivariate VAR for GDP & each monthly series in the list
...
if saveflag  == 1
    ...
    xlswrite(FileName,{['IC     = ' num2str(P.IC)]}    , 'RMSE_V','B5')
    xlswrite(FileName,{['MaxLag = ' num2str(P.lags)]}  , 'RMSE_V','B6')
